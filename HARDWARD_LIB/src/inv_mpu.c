...
bool i2c_write(uint8_t SlaveAddr, uint8_t interAddr, uint8_t len, uint8_t *wbuf)
{
	uint8_t state; 
	state = IICDevice_WriteBytes(SlaveAddr<<1,interAddr,len,wbuf);
	return  !state;
}
bool i2c_read(uint8_t SlaveAddr, uint8_t interAddr, uint8_t len, uint8_t *rbuf)
{
	uint8_t state; 
	state = IICDevice_ReadBytes(SlaveAddr<<1,interAddr,len,rbuf);
	return  !state;
}
